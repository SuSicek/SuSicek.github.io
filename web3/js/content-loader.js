...
class ContentRenderer {
    ...
    async loadContent() {
        try {
            const response = await fetch('/web3/data/content.json');
    ...
    renderAboutUs() {
        ...
        if (thumbnails) {
            thumbnails.innerHTML = aboutUs.divisions.map(division => `
                <button class="thumbnail AboutUs-thumb" onclick="window.location.href='/web3/html/division-template.html?division=${division.name.toLowerCase()}'">
    ...
    renderShop() {
        ...
        // Header - Add title rendering
        const shopTitleElement = document.querySelector('#shop-title');
        if (shopTitleElement) shopTitleElement.textContent = shop.title;
    ...
    renderContact() {
        ...
        if (ctaBtn) {
            ...
            ctaBtn.setAttribute('href', '/web3/html/contact-us.html');
            ...
            if (ctaBtn.tagName.toLowerCase() === 'button') {
                ...
                a.setAttribute('href', '/web3/html/contact-us.html');
