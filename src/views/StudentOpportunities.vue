<template>
  <div class="student-opportunities-page bg-white fill-height">
    ...
    <div class="job-header py-16 position-relative overflow-hidden" style="min-height: 480px; display: flex; align-items: flex-end;">
        ...
        <div class="job-header-bg position-absolute w-100 h-100" style="top:0; left:0; z-index:0; background-image: url('/fotky/studenti.jpg'); background-size: cover; background-position: center;"></div>
